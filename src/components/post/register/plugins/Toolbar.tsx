...
function Select({ onChange, className, options, value }: Props) {
  return (
...
function BlockOptionsDropdownList({ editor, blockType, toolbarRef, setShowBlockOptionsDropDown }: BlockOptionsProps) {
