...
import { ButtonWrapper, Footer, Container } from './LoginErrorModal.style'
...
function LoginErrorModal() {
  ...
  return (
    <Container format={'horizontal'}>
      <Content>
        <Font fontType="title" fontSize="1.375rem">
          로그인 후 이용해주세요.
        </Font>
      </Content>
      <Footer>
        <ButtonWrapper>
          <Button buttonType="destructive" onClick={() => dispatch(closeModal())} isTextWhite>
            취소
          </Button>
