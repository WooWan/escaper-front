...
function ThemeInfo(props: IProps) {
  ...
  return (
    <div>
      <MainInfo>
        <ImageContainer>
          <Image
            ...
            // objectFit={"cover"}
            alt="theme" width={200} height={350}
          />
          <InfoBox>
            <Row>
              <h2>판타지</h2>
      ...
      <section>
        <Description isActive={isMore}>Production grade React applications that scale. The world's leading companies use
          Next.js by Vercel to build static and dynamic websites and web applications
          ...
          If you have questions about anything related to Next.js, you're always welcome to ask our community on GitHub
          Discussions.
        </Description>
